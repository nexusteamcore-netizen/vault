    ...
    <>
      <div className="page-header" style={{ marginBottom: 40 }}>
        <div>
          ...
          <p className="page-subtitle" style={{ fontSize: 16, maxWidth: 600 }}>Get assistance with Vaultix configuration, report an incident, or join our community of security-minded developers.</p>
        </div>
      </div>
      ...
      <div className="page-body" style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1fr) minmax(300px, 1fr)', gap: 24 }}>
          <a href="mailto:support@vaultix.dev" className="card fade-up hover-expand" style={{ display: 'flex', flexDirection: 'column', padding: 32, textDecoration: 'none', background: 'linear-gradient(180deg, rgba(255,255,255,0.03) 0%, rgba(20,20,20,0) 100%)', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <a href="https://discord.gg/vaultix" target="_blank" rel="noreferrer" className="card fade-up hover-expand" style={{ animationDelay: '0.1s', display: 'flex', flexDirection: 'column', padding: 32, textDecoration: 'none', background: 'linear-gradient(180deg, rgba(255,255,255,0.03) 0%, rgba(20,20,20,0) 100%)', border: '1px solid rgba(255,255,255,0.08)' }}>
            ...
            <div style={{ padding: '24px 32px', borderBottom: '1px solid var(--border)' }}>
              <div style={{ display: 'flex', gap: 16 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.6, margin: 0 }}>If your agent stops responding or throws `EOF` errors, typically your Terminal session dropped the connection. Verify that the <code>VAULTIX_TOKEN</code> corresponds exactly to a non-revoked token in your <a href="/mcp" style={{ color: 'var(--accent)' }}>dashboard</a>. Restarting Claude Desktop completely flushes local caches.</p>
                </div>
              </div>
            </div>
